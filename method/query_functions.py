...
class DataQuery:
    ...
    def __init__(self):
        ...
        self.peopledata_path = current_path + '\data\people.xlsx'
        self.basedata_path = current_path + '\data\\baseinfo.xlsx'
        self.balance_static_path = current_path + '\data\\balance_static.xlsx'
    ...
    def query_people_data(self, report_year, stock_name):
        ...
        data = data.loc[(data['年份'] == int(report_year[0]))]
