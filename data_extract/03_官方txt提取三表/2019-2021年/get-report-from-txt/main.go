...
// 官方txt文件输入位置,末尾需要有\\
var dir_in string = "D:\\LLM_dev\\FinGPT-intern\\pdf_to_txt-main\\txt\\"

//var dir_in string = "D:\\LLM_dev\\FinanceChatGLM-main\\data_extract\\存放txt\\"

// 提取的三表输出位置,末尾需要有\\
var dir_out string = "D:\\LLM_dev\\FinGPT-intern\\txt2table\\tableResults\\"
...
func get_all_report(filepath string) {
	...
	//filepath = strings.Split(filepath, ".")[0] + "_txt.txt"
	...
	for scanner.Scan() {
		...
		var record Record
		//jsonStr, _ := strconv.Unquote(scanner.Text())
		jsonStr := scanner.Text()
		//fmt.Printf(jsonStr + "\n")
		////jsonStr = strings.ReplaceAll(jsonStr, "\"", "“")
		//jsonStr = strings.Replace(jsonStr, "'", "\"", 10)
		//fmt.Printf(jsonStr + "\n")
		//jsonStr = strings.Replace(jsonStr, ": '", ": \"", 1)
		//jsonStr = strings.ReplaceAll(jsonStr, "\\", "")
		////jsonStr = strings.ReplaceAll(jsonStr, "''", "' '")
		//jsonStr = strings.ReplaceAll(jsonStr, "'}", "\"}")
		//jsonStr = strings.ReplaceAll(jsonStr, "<Page:", "")
		//jsonStr = strings.ReplaceAll(jsonStr, ">", "")
		//fmt.Printf(jsonStr + "\n")
		//jsonStr, _ = strconv.Unquote("\"" + jsonStr + "\"")
		err := json.Unmarshal([]byte(jsonStr), &rawRecord)
